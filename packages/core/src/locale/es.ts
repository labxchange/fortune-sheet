export default {
  ...
  // English placeholders: this locale had no insertLink object at all, so
  // every insertLink.* read threw — including the aria-labels the link card
  // now depends on. Keys are here for translators to fill.
  insertLink: {
