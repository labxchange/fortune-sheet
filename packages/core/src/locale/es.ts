export default {
  ...
  info: {
    ...
    addRowsInputLabel: "Número de filas a añadir",
    ...
    formulaSuggestionsAvailable:
      "${count} sugerencias de fórmulas disponibles.",
    ...
    colorNames: {
      "#000000": "Negro",
      "#444444": "Gris oscuro 3",
      "#666666": "Gris oscuro 2",
      "#999999": "Gris oscuro 1",
      "#cccccc": "Gris claro 1",
      "#eeeeee": "Gris claro 2",
      "#f3f3f3": "Gris claro 3",
      "#ffffff": "Blanco",
    ...
    shortcutSearchPlaceholder: "Buscar por acción o tecla",
    shortcutSearchNoResults: "Ningún atajo coincide con “${query}”.",
    shortcutSearchResultCount: "${count} atajos encontrados.",
    shortcutGroupNavigation: "Navegación",
    shortcutGroupSelection: "Selección",
    shortcutGroupEditing: "Edición y formato",
    shortcutGroupData: "Datos y menús",
    shortcutScrollableRegion: "Atajos de teclado, con desplazamiento",
    shortcutDescriptions: {
      moveBetweenCells: "Moverse entre celdas",
      moveRight: "Mover a la derecha",
      moveLeft: "Mover a la izquierda",
      goToToolbar: "Ir a la barra de herramientas",
      goToSpreadsheet: "Ir a la hoja de cálculo",
      goToSheetTabs: "Ir a la barra de pestañas de hojas",
      nextSheet: "Hoja siguiente",
      previousSheet: "Hoja anterior",
      selectRange: "Seleccionar rango",
      selectAll: "Seleccionar todas las celdas",
      selectRow: "Seleccionar toda la fila",
      selectColumn: "Seleccionar toda la columna",
      addSelectionRange: "Añadir otro rango a la selección",
      editCell: "Editar la celda actual",
      confirmCellEdit: "Confirmar edición de celda y mover hacia abajo",
      deleteCellContent: "Eliminar contenido de celda",
      copy: "Copiar",
      cut: "Cortar",
      paste: "Pegar",
      pasteValuesOnly: "Pegar solo valores",
      undo: "Deshacer",
      redo: "Rehacer",
      autoFillDown:
        "Autocompletar selección hacia abajo desde la primera celda",
      autoFillRight:
        "Autocompletar selección hacia la derecha desde la primera celda",
      boldText: "Texto en negrita",
      find: "Buscar",
      replace: "Reemplazar",
      openFilterMenu: "Abrir el menú de filtro de esta columna",
      contextMenu: "Abrir menú contextual",
  ...
  border: {
    ...
    borderOutside: "Borde exterior",
    borderInside: "Borde interior",
    borderHorizontal: "Bordes horizontales",
    borderVertical: "Bordes verticales",
    borderColor: "Color del borde",
    borderSize: "Grosor del borde",
    borderSlash: "Borde diagonal",
    borderDefault: "Predeterminado",
  ...
  insertLink: {
    linkText: "Texto a mostrar",
    linkType: "Tipo de enlace",
    linkAddress: "Dirección del enlace",
    linkSheet: "Hoja de cálculo",
    linkCell: "Rango de celdas",
    linkTooltip: "Sugerencia",
    selectCellRange: "Seleccionar rango de celdas",
    cellRangePlaceholder:
      "Selecciona las celdas con el cursor o escríbelas directamente",
    placeholder1: "Introduce la dirección del enlace web",
    placeholder2: "Introduce la celda que quieres referenciar, por ejemplo A1",
    placeholder3: "Introduce el contenido de la sugerencia",
    tooltipInfo1: "Introduce un enlace válido",
    invalidCellRangeTip:
      "Introduce un rango de celdas correcto, por ejemplo Hoja1!A1:C8",
    openLink: "Abrir enlace",
    goTo: "Ir a ${linkAddress}",
