export default {
  ...
  info: {
    ...
    formulaSuggestionsAvailable: "有 ${count} 個公式建議。",
    ...
    toolbarMergeNeedsRange: "請選擇兩個或更多儲存格以合併。",
    toolbarMergeNothingMerged: "選取範圍中沒有合併的儲存格。",
    toolbarTextWrapSet: "文字換行：${mode}。",
    toolbarFontSizeSet: "字型大小：${size}。",
    toolbarFilterOn: "已開啟篩選。",
    toolbarFilterOff: "已關閉篩選。",
    toolbarFontColorSet: "文字顏色：${color}。",
    toolbarFontColorRemoved: "已移除文字顏色。",
    toolbarBackgroundColorSet: "儲存格顏色：${color}。",
    toolbarBackgroundColorRemoved: "已移除儲存格顏色。",
    toolbarBorderColorSet: "邊框顏色：${color}。",
    toolbarBorderColorRemoved: "已移除邊框顏色。",
    toolbarBorderSet: "邊框：${border}。",
    toolbarBorderCleared: "已清除邊框。",
    hexColorInput: "十六進位顏色",
    hexColorInvalid: "不是有效顏色。請輸入十六進位值，例如 #1a73e8。",
    ...
    zoomIn: "放大",
    zoomOut: "縮小",
    filterColumn: "欄 ${column} 的篩選。",
    addedSelectionRange: "已向選取範圍加入一個範圍。使用方向鍵移動它。",
    shortcuts: "鍵盤快速鍵",
    shortcutKeysColumn: "快速鍵",
    shortcutActionColumn: "動作",
    shortcutSearchLabel: "搜尋快速鍵",
    shortcutSearchPlaceholder: "依動作或按鍵搜尋",
    shortcutSearchNoResults: "沒有與「${query}」相符的快速鍵。",
    shortcutSearchResultCount: "找到 ${count} 個快速鍵。",
    shortcutGroupNavigation: "導覽",
    ...
    shortcutDescriptions: {
      ...
      moveLeft: "向左移動",
      goToToolbar: "前往工具列",
      goToSpreadsheet: "前往試算表",
      goToSheetTabs: "前往工作表標籤列",
      nextSheet: "下一個工作表",
      ...
      selectRow: "選取整列",
      selectColumn: "選取整欄",
      addSelectionRange: "向選取範圍加入另一個範圍",
      editCell: "編輯目前儲存格",
      confirmCellEdit: "確認編輯並向下移動",
      deleteCellContent: "刪除儲存格內容",
      copy: "複製",
      cut: "剪下",
      paste: "貼上",
      pasteValuesOnly: "僅貼上數值",
      undo: "復原",
      redo: "重做",
      autoFillDown: "從第一個儲存格向下自動填充",
      autoFillRight: "從第一個儲存格向右自動填充",
      boldText: "加粗文字",
      find: "尋找",
      replace: "取代",
      openFilterMenu: "開啟此欄的篩選選單",
      contextMenu: "開啟內容選單",
      rowContextMenu: "開啟列標題內容選單",
      columnContextMenu: "開啟欄標題內容選單",
      openShortcuts: "開啟鍵盤快速鍵",
      jumpToEdge: "跳至資料區域邊緣",
      extendToEdge: "將選取範圍延伸至邊緣",
      insertDateTime: "插入目前日期和時間",
      zoomIn: "放大",
      zoomOut: "縮小",
      zoomReset: "重設縮放",
  ...
  filter: {
    ...
    announceFilterApplied: "已套用篩選。",
    announceFilteredByColor: "已按顏色篩選。",
  },
  rightclick: {
    copy: "複製",
    copyAs: "複製為",
    ...
    insertColumnCountLabel: "要插入的列數",
    insertRowCountLabel: "要插入的行數",
    rowHeightLabel: "行高（像素）",
    columnWidthLabel: "列寬（像素）",

    announceCopied: "已複製所選內容。",
    announcePasted: "已粘貼所選內容。",
    announceColumnInsertedLeft: "已在左側插入 1 列。",
    announceColumnsInsertedLeft: "已在左側插入 ${count} 列。",
    announceColumnInsertedRight: "已在右側插入 1 列。",
    announceColumnsInsertedRight: "已在右側插入 ${count} 列。",
    ...
    announceRowHidden: "已隱藏 1 行。",
    announceRowsHidden: "已隱藏 ${count} 行。",
    announceColumnHidden: "已隱藏 1 列。",
    announceColumnsHidden: "已隱藏 ${count} 列。",
    announceCleared: "已清除內容。",
    announceRowsShown: "已顯示隱藏的行。",
    announceColumnsShown: "已顯示隱藏的列。",
    announceRowHeightSet: "行高已設定為 ${value} 像素。",
    announceColumnWidthSet: "列寬已設定為 ${value} 像素。",
    announceSortedAsc: "已按升序排列。",
    announceSortedDesc: "已按降序排列。",
    announceFilterCreated: "已建立篩選。",
    announceFilterRemoved: "已移除篩選。",
  },
  comment: {
    insert: "新建批註",
    edit: "編輯批註",
  ...
  insertLink: {
    selectCellRange: "選擇儲存格範圍",
    cellRangePlaceholder: "可用滑鼠框選儲存格，或直接輸入範圍",
    goTo: "跳轉至 ${linkAddress}",
    invalidCellRangeTip: "請輸入正確的儲存格範圍，例如 工作表1!A1:C8",
    openLink: "開啟連結",
    linkText: "文字",
    linkType: "連結類型",
    external: "外部連結",
