export default {
  ...
  insertLink: {
    // English placeholders: these five were absent here, so the link card's
    // aria-labels resolved to undefined and React dropped the attribute,
    // silently leaving those buttons unnamed again.
