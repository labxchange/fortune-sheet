export default {
  ...
  info: {
    ...
    formulaSuggestionsAvailable: "公式建议：${count} 个。",
    ...
    zoomIn: "放大",
    zoomOut: "缩小",
    filterColumn: "列 ${column} 的筛选。",
    addedSelectionRange: "已向选区添加一个范围。使用方向键移动它。",
    shortcuts: "键盘快捷键",
    shortcutKeysColumn: "快捷键",
    shortcutActionColumn: "操作",
    shortcutSearchLabel: "搜索快捷键",
    shortcutSearchPlaceholder: "按操作或按键搜索",
    shortcutSearchNoResults: "没有与“${query}”匹配的快捷键。",
    shortcutSearchResultCount: "找到 ${count} 个快捷键。",
    ...
    shortcutDescriptions: {
      ...
      moveLeft: "向左移动",
      goToToolbar: "转到工具栏",
      goToSpreadsheet: "转到表格",
      goToSheetTabs: "转到工作表标签栏",
      nextSheet: "下一个工作表",
      ...
      selectRow: "选择整行",
      selectColumn: "选择整列",
      addSelectionRange: "向选区添加另一个范围",
      editCell: "编辑当前单元格",
      confirmCellEdit: "确认编辑并向下移动",
      deleteCellContent: "删除单元格内容",
      copy: "复制",
      cut: "剪切",
      paste: "粘贴",
      pasteValuesOnly: "仅粘贴数值",
      undo: "撤销",
      redo: "重做",
      autoFillDown: "从首个单元格向下自动填充",
      autoFillRight: "从首个单元格向右自动填充",
      boldText: "加粗文本",
      find: "查找",
      replace: "替换",
      openFilterMenu: "打开此列的筛选菜单",
      contextMenu: "打开上下文菜单",
      rowContextMenu: "打开行标题上下文菜单",
      columnContextMenu: "打开列标题上下文菜单",
      openShortcuts: "打开键盘快捷键",
      jumpToEdge: "跳转到数据区域边缘",
      extendToEdge: "将选区扩展到边缘",
