export default {
  ...
  toolbar: {
    toolbar: "उपकरण पट्टी",
    "keyboard-shortcuts": "कुंजीपटल शॉर्टकट",
    undo: "पूर्ववत करें",
    redo: "फिर से करें",
  ...
  info: {
    ...
    nameBox: "नाम बॉक्स",
    nameBoxInvalidReference: "संदर्भ पहचाना नहीं गया।",
    ...
    colorNames: {
      "#000000": "काला",
      "#444444": "गहरा स्लेटी 3",
      "#666666": "गहरा स्लेटी 2",
      "#999999": "गहरा स्लेटी 1",
      "#cccccc": "हल्का स्लेटी 1",
      "#eeeeee": "हल्का स्लेटी 2",
      "#f3f3f3": "हल्का स्लेटी 3",
      "#ffffff": "सफ़ेद",
      "#f00f00": "लाल",
      "#f90f90": "गुलाबी",
      "#ff0ff0": "मैजेंटा",
      ...
      "#f0ff0f": "पीला",
      "#f4cccc": "हल्का लाल 3",
      "#fce5cd": "हल्का नारंगी 3",
      "#fff2cc": "हल्का पीला 3",
      "#d9ead3": "हल्का हरा 3",
      "#d0e0e3": "हल्का नीला-हरा 3",
      "#cfe2f3": "हल्का नीला 3",
      "#d9d2e9": "हल्का बैंगनी 3",
      "#ead1dc": "हल्का मैजेंटा 3",
      "#ea9999": "हल्का लाल 2",
      "#f9cb9c": "हल्का नारंगी 2",
      "#ffe599": "हल्का पीला 2",
      "#b6d7a8": "हल्का हरा 2",
      "#a2c4c9": "हल्का नीला-हरा 2",
      "#9fc5e8": "हल्का नीला 2",
      "#b4a7d6": "हल्का बैंगनी 2",
      "#d5a6bd": "हल्का मैजेंटा 2",
      "#e06666": "हल्का लाल 1",
      "#f6b26b": "हल्का नारंगी 1",
      "#ffd966": "हल्का पीला 1",
      "#93c47d": "हल्का हरा 1",
      "#76a5af": "हल्का नीला-हरा 1",
      "#6fa8dc": "हल्का नीला 1",
      "#8e7cc3": "हल्का बैंगनी 1",
      "#c27ba0": "हल्का मैजेंटा 1",
      "#c00c00": "गहरा लाल 1",
      "#e69138": "गहरा नारंगी 1",
      "#f1c232": "गहरा पीला 1",
      "#6aa84f": "गहरा हरा 1",
      "#45818e": "गहरा नीला-हरा 1",
      "#3d85c6": "गहरा नीला 1",
      "#674ea7": "गहरा बैंगनी 1",
      "#a64d79": "गहरा मैजेंटा 1",
      "#900900": "गहरा लाल 2",
      "#b45f06": "गहरा नारंगी 2",
      "#bf9000": "गहरा पीला 2",
      "#38761d": "गहरा हरा 2",
      "#134f5c": "गहरा नीला-हरा 2",
      "#0b5394": "गहरा नीला 2",
      "#351c75": "गहरा बैंगनी 2",
      "#741b47": "गहरा मैजेंटा 2",
      "#600600": "गहरा लाल 3",
      "#783f04": "गहरा नारंगी 3",
      "#7f6000": "गहरा पीला 3",
      "#274e13": "गहरा हरा 3",
      "#0c343d": "गहरा नीला-हरा 3",
      "#073763": "गहरा नीला 3",
      "#20124d": "गहरा बैंगनी 3",
      "#4c1130": "गहरा मैजेंटा 3",
    },
    zoomIn: "ज़ूम इन",
    zoomOut: "ज़ूम आउट",
    // These were Spanish, copied wholesale into the Hindi file when the
    // screen-reader shortcut strings were first added. Replaced with Hindi
    // rather than carried over.
    filterColumn: "स्तंभ ${column} के लिए फ़िल्टर।",
    addedSelectionRange:
    ...
    shortcutSearchPlaceholder: "क्रिया या कुंजी से खोजें",
    shortcutSearchNoResults: "“${query}” से मेल खाता कोई शॉर्टकट नहीं है।",
    shortcutSearchResultCount: "${count} शॉर्टकट मिले।",
    ...
    shortcutDescriptions: {
      ...
      moveLeft: "बाईं ओर जाएँ",
      goToToolbar: "टूलबार पर जाएँ",
      goToSpreadsheet: "स्प्रेडशीट पर जाएँ",
      goToSheetTabs: "शीट टैब बार पर जाएँ",
      nextSheet: "अगली शीट",
      previousSheet: "पिछली शीट",
      selectRange: "श्रेणी चुनें",
      selectAll: "सभी कक्ष चुनें",
      selectRow: "पूरी पंक्ति चुनें",
      selectColumn: "पूरा स्तंभ चुनें",
      addSelectionRange: "चयन में एक और श्रेणी जोड़ें",
      editCell: "वर्तमान कक्ष संपादित करें",
      confirmCellEdit: "कक्ष संपादन की पुष्टि करें और नीचे जाएँ",
      deleteCellContent: "कक्ष की सामग्री हटाएँ",
      copy: "प्रतिलिपि",
      cut: "काटें",
      paste: "चिपकाएँ",
      pasteValuesOnly: "केवल मान चिपकाएँ",
      undo: "पूर्ववत करें",
      redo: "फिर से करें",
      autoFillDown: "पहले कक्ष से नीचे स्वतः भरें",
      autoFillRight: "पहले कक्ष से दाईं ओर स्वतः भरें",
      boldText: "गाढ़ा पाठ",
      find: "खोजें",
      replace: "बदलें",
      openFilterMenu: "इस स्तंभ का फ़िल्टर मेन्यू खोलें",
      contextMenu: "संदर्भ मेन्यू खोलें",
  ...
  sort: {
    ...
    nothingToSort: "चयनित रेंज में सॉर्ट करने के लिए कुछ नहीं है।",
  },
  filter: {
    ...
    announceFilterApplied: "फ़िल्टर लागू किया गया।",
    announceFilteredByColor: "रंग के अनुसार फ़िल्टर किया गया।",
  },
  rightclick: {
    copy: "कॉपी",
    ...
    createFilter: "फ़िल्टर बनाएं",
    removeFilter: "फ़िल्टर हटाएं",

    insertColumnCountLabel: "डालने के लिए स्तंभों की संख्या",
    insertRowCountLabel: "डालने के लिए पंक्तियों की संख्या",
    rowHeightLabel: "पंक्ति की ऊंचाई पिक्सेल में",
    columnWidthLabel: "स्तंभ की चौड़ाई पिक्सेल में",

    announceCopied: "चयन कॉपी किया गया।",
    announcePasted: "चयन पेस्ट किया गया।",
    announceColumnInsertedLeft: "1 स्तंभ बाएं डाला गया।",
    announceColumnsInsertedLeft: "${count} स्तंभ बाएं डाले गए।",
    announceColumnInsertedRight: "1 स्तंभ दाएं डाला गया।",
    announceColumnsInsertedRight: "${count} स्तंभ दाएं डाले गए।",
    announceRowInsertedAbove: "1 पंक्ति ऊपर डाली गई।",
    announceRowsInsertedAbove: "${count} पंक्तियां ऊपर डाली गईं।",
    announceRowInsertedBelow: "1 पंक्ति नीचे डाली गई।",
    announceRowsInsertedBelow: "${count} पंक्तियां नीचे डाली गईं।",
    announceColumnDeleted: "1 स्तंभ हटाया गया।",
    announceColumnsDeleted: "${count} स्तंभ हटाए गए।",
    announceRowDeleted: "1 पंक्ति हटाई गई।",
    announceRowsDeleted: "${count} पंक्तियां हटाई गईं।",
    announceRowHidden: "1 पंक्ति छुपाई गई।",
    announceRowsHidden: "${count} पंक्तियां छुपाई गईं।",
    announceColumnHidden: "1 स्तंभ छुपाया गया।",
    announceColumnsHidden: "${count} स्तंभ छुपाए गए।",
    announceCleared: "कॉन्टेंट साफ किया गया।",
    announceRowsShown: "छुपाई गई पंक्तियां दिखाई गईं।",
    announceColumnsShown: "छुपाए गए स्तंभ दिखाए गए।",
    announceRowHeightSet: "पंक्ति की ऊंचाई ${value} पिक्सेल पर सेट की गई।",
    announceColumnWidthSet: "स्तंभ की चौड़ाई ${value} पिक्सेल पर सेट की गई।",
    announceSortedAsc: "आरोही क्रम में क्रमबद्ध किया गया।",
    announceSortedDesc: "अवरोही क्रम में क्रमबद्ध किया गया।",
    announceFilterCreated: "फ़िल्टर बनाया गया।",
    announceFilterRemoved: "फ़िल्टर हटाया गया।",
  },
  comment: {
    insert: "डालें",
    edit: "संपादित करें",
  ...
  findAndReplace: {
    resultRowLabel: "शीट ${sheet}, सेल ${cell}, मूल्य ${value}",
    resultsListName: "खोज परिणाम",
  ...
  sheetconfig: {
    ...
    announceSheetRenamed: "शीट का नाम बदलकर ${name} किया गया।",
    announceSheetRenameCancelled: "नाम बदलना रद्द किया गया।",
