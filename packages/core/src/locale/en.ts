export default {
  ...
  toolbar: {
    ...
    // `link` is the key the toolbar actually reads (items are looked up as
    // toolbar[name], and the item's name is "link", so insertLink was never
    // used). insertLink is kept as a published-API alias so a consumer
    // overriding it does not silently lose their string; remove at the next
    // intentional major.
  ...
  info: {
    ...
    formulaSuggestions: "Formula suggestions",
    formulaSuggestionsAvailable: "Formula suggestions available: ${count}.",
    ...
    zoomIn: "Zoom in",
    zoomOut: "Zoom out",
    filterColumn: "Filter for column ${column}.",
    addedSelectionRange:
      "Added a range to the selection. Use the arrow keys to move it.",
    // The shortcuts dialog. Key notation lives in code, not here — see
    ...
    shortcutSearchPlaceholder: "Search by action or key",
    shortcutSearchNoResults: "No shortcuts match “${query}”.",
    shortcutSearchResultCount: "${count} shortcuts found.",
    ...
    shortcutDescriptions: {
      ...
      moveLeft: "Move left",
      goToToolbar: "Go to toolbar",
      goToSpreadsheet: "Go to spreadsheet",
      goToSheetTabs: "Go to sheet tab bar",
      ...
      addSelectionRange: "Add another range to the selection",
      editCell: "Edit the current cell",
      confirmCellEdit: "Confirm cell edit and move down",
      deleteCellContent: "Delete cell content",
      copy: "Copy",
      cut: "Cut",
      paste: "Paste",
      pasteValuesOnly: "Paste values only",
      undo: "Undo",
      redo: "Redo",
      autoFillDown: "Auto-fill selection down from first cell",
      autoFillRight: "Auto-fill selection right from first cell",
      boldText: "Bold text",
      find: "Find",
      replace: "Replace",
      openFilterMenu: "Open the filter menu for this column",
      ...
      moveBetweenFormulaSuggestions: "Move between formula suggestions",
      acceptFormulaSuggestion: "Insert the highlighted formula suggestion",
    },
  },
  currencyDetail: [
