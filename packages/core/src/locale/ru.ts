export default {
  ...
  info: {
    ...
    addRowsInputLabel: "Количество добавляемых строк",
    ...
    colorNames: {
      "#000000": "Чёрный",
      "#444444": "Тёмно-серый 3",
      "#666666": "Тёмно-серый 2",
      "#999999": "Тёмно-серый 1",
      "#cccccc": "Светло-серый 1",
      "#eeeeee": "Светло-серый 2",
      "#f3f3f3": "Светло-серый 3",
      "#ffffff": "Белый",
      "#f00f00": "Красный",
      "#f90f90": "Розовый",
      "#ff0ff0": "Пурпурный",
      ...
      "#90f90f": "Лаймовый",
      "#f0ff0f": "Жёлтый",
      "#f4cccc": "Светло-красный 3",
      "#fce5cd": "Светло-оранжевый 3",
      "#fff2cc": "Светло-жёлтый 3",
      "#d9ead3": "Светло-зелёный 3",
      "#d0e0e3": "Светло-бирюзовый 3",
      "#cfe2f3": "Светло-синий 3",
      "#d9d2e9": "Светло-фиолетовый 3",
      "#ead1dc": "Светло-пурпурный 3",
      "#ea9999": "Светло-красный 2",
      "#f9cb9c": "Светло-оранжевый 2",
      "#ffe599": "Светло-жёлтый 2",
      "#b6d7a8": "Светло-зелёный 2",
      "#a2c4c9": "Светло-бирюзовый 2",
      "#9fc5e8": "Светло-синий 2",
      "#b4a7d6": "Светло-фиолетовый 2",
      "#d5a6bd": "Светло-пурпурный 2",
      "#e06666": "Светло-красный 1",
      "#f6b26b": "Светло-оранжевый 1",
      "#ffd966": "Светло-жёлтый 1",
      "#93c47d": "Светло-зелёный 1",
      "#76a5af": "Светло-бирюзовый 1",
      "#6fa8dc": "Светло-синий 1",
      "#8e7cc3": "Светло-фиолетовый 1",
      "#c27ba0": "Светло-пурпурный 1",
      "#c00c00": "Тёмно-красный 1",
      "#e69138": "Тёмно-оранжевый 1",
      "#f1c232": "Тёмно-жёлтый 1",
      "#6aa84f": "Тёмно-зелёный 1",
      "#45818e": "Тёмно-бирюзовый 1",
      "#3d85c6": "Тёмно-синий 1",
      "#674ea7": "Тёмно-фиолетовый 1",
      "#a64d79": "Тёмно-пурпурный 1",
      "#900900": "Тёмно-красный 2",
      "#b45f06": "Тёмно-оранжевый 2",
      "#bf9000": "Тёмно-жёлтый 2",
      "#38761d": "Тёмно-зелёный 2",
      "#134f5c": "Тёмно-бирюзовый 2",
      "#0b5394": "Тёмно-синий 2",
      "#351c75": "Тёмно-фиолетовый 2",
      "#741b47": "Тёмно-пурпурный 2",
      "#600600": "Тёмно-красный 3",
      "#783f04": "Тёмно-оранжевый 3",
      "#7f6000": "Тёмно-жёлтый 3",
      "#274e13": "Тёмно-зелёный 3",
      "#0c343d": "Тёмно-бирюзовый 3",
      "#073763": "Тёмно-синий 3",
      "#20124d": "Тёмно-фиолетовый 3",
      "#4c1130": "Тёмно-пурпурный 3",
    },
    zoomIn: "Увеличить",
    zoomOut: "Уменьшить",
    filterColumn: "Фильтр для столбца ${column}.",
    addedSelectionRange:
    ...
    shortcutSearchPlaceholder: "Поиск по действию или клавише",
    shortcutSearchNoResults: "Нет сочетаний, соответствующих «${query}».",
    shortcutSearchResultCount: "Найдено сочетаний: ${count}.",
    ...
    shortcutDescriptions: {
      ...
      moveLeft: "Перейти влево",
      goToToolbar: "Перейти к панели инструментов",
      goToSpreadsheet: "Перейти к таблице",
      goToSheetTabs: "Перейти к панели вкладок листов",
      nextSheet: "Следующий лист",
      previousSheet: "Предыдущий лист",
      selectRange: "Выбор диапазона",
      selectAll: "Выделить все ячейки",
      selectRow: "Выделить всю строку",
      selectColumn: "Выделить весь столбец",
      addSelectionRange: "Добавить ещё один диапазон к выделению",
      editCell: "Редактировать текущую ячейку",
      confirmCellEdit: "Подтвердить редактирование ячейки и перейти вниз",
      deleteCellContent: "Удалить содержимое ячейки",
      copy: "Копировать",
      cut: "Вырезать",
      paste: "Вставить",
      pasteValuesOnly: "Вставить только значения",
      undo: "Отменить",
      redo: "Повторить",
      autoFillDown: "Автозаполнение вниз из первой ячейки",
      autoFillRight: "Автозаполнение вправо из первой ячейки",
      boldText: "Жирный текст",
      find: "Найти",
      replace: "Заменить",
      openFilterMenu: "Открыть меню фильтра для этого столбца",
      contextMenu: "Открыть контекстное меню",
  ...
  sort: {
    ...
    nothingToSort: "В выделенном диапазоне нечего сортировать.",
  },
  filter: {
    ...
    announceFilterApplied: "Фильтр применён.",
    announceFilteredByColor: "Отфильтровано по цвету.",
  },
  rightclick: {
    copy: "Копировать",
    ...
    insertColumnCountLabel: "Количество вставляемых столбцов",
    insertRowCountLabel: "Количество вставляемых строк",
    rowHeightLabel: "Высота строки в пикселях",
    columnWidthLabel: "Ширина столбца в пикселях",

    announceCopied: "Выделение скопировано.",
    announcePasted: "Выделение вставлено.",
    announceColumnInsertedLeft: "Вставлен 1 столбец слева.",
    announceColumnsInsertedLeft: "Вставлено столбцов слева: ${count}.",
    announceColumnInsertedRight: "Вставлен 1 столбец справа.",
    announceColumnsInsertedRight: "Вставлено столбцов справа: ${count}.",
    announceRowInsertedAbove: "Вставлена 1 строка выше.",
    announceRowsInsertedAbove: "Вставлено строк выше: ${count}.",
    announceRowInsertedBelow: "Вставлена 1 строка ниже.",
    announceRowsInsertedBelow: "Вставлено строк ниже: ${count}.",
    announceColumnDeleted: "Удалён 1 столбец.",
    announceColumnsDeleted: "Удалено столбцов: ${count}.",
    announceRowDeleted: "Удалена 1 строка.",
    announceRowsDeleted: "Удалено строк: ${count}.",
    announceRowHidden: "Скрыта 1 строка.",
    announceRowsHidden: "Скрыто строк: ${count}.",
    announceColumnHidden: "Скрыт 1 столбец.",
    announceColumnsHidden: "Скрыто столбцов: ${count}.",
    announceCleared: "Содержимое очищено.",
    announceRowsShown: "Скрытые строки показаны.",
    announceColumnsShown: "Скрытые столбцы показаны.",
    announceRowHeightSet: "Высота строки установлена: ${value} пикселей.",
    announceColumnWidthSet: "Ширина столбца установлена: ${value} пикселей.",
    announceSortedAsc: "Отсортировано по возрастанию.",
    announceSortedDesc: "Отсортировано по убыванию.",
    announceFilterCreated: "Фильтр создан.",
    announceFilterRemoved: "Фильтр удалён.",
  },
  comment: {
    insert: "Вставить",
    edit: "Редактировать",
  ...
  findAndReplace: {
    resultRowLabel: "Лист ${sheet}, ячейка ${cell}, значение ${value}",
    resultsListName: "Результаты поиска",
