  ...
  var getToolbarItem = React.useCallback(function (name, i) {
    ...
    if (name === "freeze") {
      ...
      return /*#__PURE__*/React__default['default'].createElement(Combo, {
        ...
        return /*#__PURE__*/React__default['default'].createElement(Select, null, _items5.map(function (_ref0) {
          var text = _ref0.text,
            value = _ref0.value;
          return /*#__PURE__*/React__default['default'].createElement(Option, {
            key: value,
...
var CustomSort = function CustomSort() {
  ...
  var _useDialog = useDialog(),
    hideDialog = _useDialog.hideDialog;
  var handleSortConfirm = React.useCallback(function () {
    setContext(function (draftCtx) {
  ...
  var startCell = "".concat(core.indexToColumnChar(col_start)).concat(row_start + 1);
  var endCell = "".concat(core.indexToColumnChar(col_end)).concat(row_end + 1);
  var sheetIndex = core.getSheetIndex(context, context.currentSheetId);
  ...
  }, /*#__PURE__*/React__default['default'].createElement("span", null, sort.sortRangeTitle), /*#__PURE__*/React__default['default'].createElement("span", {
    className: "fortune-sort-title-range"
  }, startCell), /*#__PURE__*/React__default['default'].createElement("span", null, sort.sortRangeTitleTo), /*#__PURE__*/React__default['default'].createElement("span", {
    className: "fortune-sort-title-range"
  }, endCell))), /*#__PURE__*/React__default['default'].createElement("div", null, /*#__PURE__*/React__default['default'].createElement("div", {
  ...
  var onKeyDown = React.useCallback(function (e) {
    ...
    if ((isContextMenuShortcut || isRowContextMenuShortcut || isColumnContextMenuShortcut) && context.allowEdit) {
      ...
      if (selected && workbookContainer.current && cellArea.current) {
        ...
        setContextWithProduce(function (draftCtx) {
          core.handleContextMenu(draftCtx, mergedSettings, syntheticContextEvent, workbookContainer.current, cellArea.current, area);
        });
        e.preventDefault();
        e.stopPropagation();
        return;
